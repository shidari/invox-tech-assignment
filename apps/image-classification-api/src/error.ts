...
export const errorPairs = [
  ...
  { _tag: "rateLimitError", code: "E16" },
  { _tag: "rateLimitError", code: "E17" },
...
export const errorCodeToMessageMap: Record<ErrorCode, string> = {
  ...
  E16: "Rate limit exceeded",
  E17: "unexpected error in rate limiting",
};
...
export const createRateLimitError = (
  val: unknown,
): AppError<"rateLimitError", "E16"> => ({
  _tag: "rateLimitError",
  code: "E16",
  error: new Error(`Rate limit exceeded: ${val}`),
});

export const createRateLimitExceededError = (
  val: unknown,
): AppError<"rateLimitError", "E17"> => ({
  _tag: "rateLimitError",
  code: "E17",
  error: new Error(`unexpected error in rate limiting: ${val}`),
});
